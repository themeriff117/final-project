...
//
    ...
    preload: function ()
    {
        ...
        this.load.spritesheet('player', 'assets/HobbitLongPublished.png', { frameWidth: 40, frameHeight: 40, margin: 0, spacing: 0 });
    },
...
var WorldScene = new Phaser.Class({
    ...
    create: function ()
    {
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('player', { frames: [60, 61, 62, 63]}),
            frameRate: 10,
            repeat: -1
        });
